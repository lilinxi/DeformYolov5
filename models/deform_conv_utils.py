...
class DeformConvV1_TorchVision(nn.Module):
    def __init__(
            self,
            in_channels: int,
            out_channels: int,
        ...
        super(DeformConvV1_TorchVision, self).__init__()
...
class DeformConvV1V2_4uiiurz1(nn.Module):
    def __init__(
            self,
            in_channels: int,
            out_channels: int,
        ...
        """
        super(DeformConvV1V2_4uiiurz1, self).__init__()
        assert dilation == 1, 'dilation != 1 not supported'
        self.kernel_size = kernel_size
        self.padding = padding
        self.stride = stride
        self.zero_padding = nn.ZeroPad2d(padding)
        self.conv = nn.Conv2d(in_channels, out_channels, kernel_size=kernel_size, stride=kernel_size, groups=groups,
                              bias=bias)
...
class DeformConvV2_CHONSPQX(nn.Module):
...
if __name__ == '__main__':
    ...
    M = DeformConvV1_TorchVision(in_channels=1, out_channels=1, kernel_size=3, padding=1, bias=False)
    out = M(x)
    print(out.shape)
